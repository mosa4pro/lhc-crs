  ...
  try {
    ...
    const student = await prisma.student.findUnique({
      ...
      include: {
        ...
        sections: { include: { section: { include: { course: true, room: { include: { entity: true } }, instructor: true } } } },
  ...
  try {
    ...
    const sections = await prisma.section.findMany({
      ...
      include: {
        ...
        room: { select: { id: true, name: true, learningType: true, modality: true, address: true, entity: { select: { name: true } } } },
        instructor: { select: { id: true, name: true } },
      },
    ...
    const result = sections.map(s => {
      ...
      return {
        ...
        roomModality: s.room?.modality || null,
        roomEntityName: s.room?.entity?.name || '',
